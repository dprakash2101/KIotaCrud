...
using System;
namespace KiotaCrud.Client.Api.Contact.Item {
    /// <summary>
    /// Builds and executes requests for operations under \api\Contact\{id}
    /// </summary>
    public class ContactItemRequestBuilder : BaseRequestBuilder {
        ...
        public ContactItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/Contact/{id}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ContactItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ContactItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/Contact/{id}", rawUrl) {
        }
